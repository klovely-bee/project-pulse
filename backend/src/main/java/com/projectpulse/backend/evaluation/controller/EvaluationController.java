...
public class EvaluationController {
    ...
    @PostMapping
    public ApiResponse<EvaluationResponse> createEvaluation(@RequestBody CreateEvaluationRequest request) {
        return Result.success("Evaluation created successfully", evaluationService.createEvaluation(request));
    }

    @GetMapping("/student/{id}")
    public ApiResponse<List<EvaluationResponse>> getEvaluationsByStudent(@PathVariable Long id) {
        return Result.success("Student evaluations retrieved successfully", evaluationService.getEvaluationsByStudent(id));
    }

    @GetMapping("/team/{teamId}")
    public ApiResponse<List<EvaluationResponse>> getEvaluationsByTeam(@PathVariable Long teamId) {
        return Result.success("Team evaluations retrieved successfully", evaluationService.getEvaluationsByTeam(teamId));
    }

    @GetMapping("/target/{id}")
    public ApiResponse<List<EvaluationResponse>> getEvaluationsForStudent(@PathVariable Long id) {
